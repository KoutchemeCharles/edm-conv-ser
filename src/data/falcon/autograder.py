"""
Original CS110 client-side autograder (Aalto University).

This file is included for reference only.  The pipeline does NOT call it
directly — grading logic has been inlined into
:mod:`src.data.falcon.execution` for reliability and performance.
"""
...
custom_flags = {
    flag_audit:False,
    flag_show_input:False, # Used to be true
    flag_show_output:False, # Used to be true
